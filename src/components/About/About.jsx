      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20 lg:gap-28">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-6 leading-relaxed max-w-xl">
            ...
            back-end development, I am Software Developer and other
            modern technologies to create seamless user experiences and
            efficient solutions.
          </p>

          <a
            href="/Rajesh_Resume.pdf" // Folder path dene ki zaroorat nahi agar public folder mein hai
            download="Rajesh_Kumar_Resume.pdf" // Click karte hi download shuru ho jayega
            target="_blank"
